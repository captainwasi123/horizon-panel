...
class bahriaSalesController extends Controller
{
    //
    function totalLeads(){
       if (Auth::check()) {
            ...
            return view('bahriaSales.totalLeads', ['databelt' => $databelt, 'status' => $status, 'category' => $category, 'users' => $user, 'filter' => '0']);
        }else{
    ...
    function totalLeadsSubmit(Request $request){
       if (Auth::check()) {
            ...
            $databelt = lead::where('trash', null)
                        ...
                        ->where('lead_status', '3')
                        ->orderBy('created_at', 'desc')->get();
            return view('bahriaSales.totalLeads', ['databelt' => $databelt, 'status' => $status, 'category' => $category, 'users' => $user, 'filter' => '1', 'search_data' => $data]);
        }else{
            return redirect('/login')->with('error', 'Authentication Error');
        } 
    }
    ...
    function potentialLeads(){
       if (Auth::check()) {
            ...
            $databelt = lead::where('trash', null)
                        ...
                        ->where('lead_status', '4')
                        ->orderBy('created_at', 'desc')->get();
            return view('bahriaSales.potentialLeads', ['databelt' => $databelt, 'status' => $status, 'category' => $category, 'users' => $user, 'filter' => '0']);
        }else{
            return redirect('/login')->with('error', 'Authentication Error');
        } 
    }
    ...
    function potentialLeadsSubmit(Request $request){
       if (Auth::check()) {
            ...
            $databelt = lead::where('trash', null)
                        ...
                        ->where('lead_status', '4')
                        ->orderBy('created_at', 'desc')->get();
            return view('bahriaSales.potentialLeads', ['databelt' => $databelt, 'status' => $status, 'category' => $category, 'users' => $user, 'filter' => '1', 'search_data' => $data]);
        }else{
            return redirect('/login')->with('error', 'Authentication Error');
        } 
    }
    ...
    function clientTarget(){
       if (Auth::check()) {
            $databelt = lead::where('trash', null)
                        ->where('lead_status', '4')
                        ->orderBy('created_at', 'desc')->get();
            return view('bahriaSales.clientTarget', ['databelt' => $databelt]);
        }else{
            return redirect('/login')->with('error', 'Authentication Error');
        } 
    }
    ...
    function quotationPlan($id){
        if(Auth::check()){
            ...
            return view('bahriaSales.plan', ['data' => $data, 'descrip' => $des]);
        }else{
            return redirect('/login')->with('error', 'Authentication Error');
        }
    }
