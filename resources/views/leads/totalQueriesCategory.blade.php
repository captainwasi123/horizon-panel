...
@php $date_remind = date('Y-m-d', strtotime("-7 days")); @endphp
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="icon-people"></i></span>Total Queries | {{$name}}</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" action="{{URL::to('/query/total')}}">
                                        {{csrf_field()}}
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.potential', function() {
                ...
                $.toast({
                    ...
                    text: '<i class="jq-toast-icon ti-alert"></i><a href="{{ URL::to("/")}}/query/status/2/'+del_data+'" class="btn btn-primary btn-sm">&nbsp;&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;</a>',
                    position: 'top-center',
                    loaderBg:'#7a5449',
                    class: 'jq-has-icon jq-toast-warning',
                    hideAfter: 3500, 
