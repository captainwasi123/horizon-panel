...
@section('title', 'Potential Queries - Bahria')
@section('content')
...
@php $date_remind = date('Y-m-d', strtotime("-7 days")); @endphp
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="icon-people"></i></span>Potential Queries - Bahria</h4>
                </div>
                <!-- /Title -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click touchstart', '.visitModal',function(e){
                ...
                var dataHold = $(this).data("hold");
                $('#llid').val(id);
                $('#data_date').val(dataDate);
                if(dataHold == '1'){
                    $('#data_hold').attr('checked', 'true');
                }
