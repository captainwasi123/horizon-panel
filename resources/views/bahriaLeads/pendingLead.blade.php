...
@section('title', 'Pending Leads - Bahria')
@section('content')
...
@php $date_remind = date('Y-m-d', strtotime("-7 days")); @endphp
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="fa fa-clock-o"></i></span>Pending Leads - Bahria</h4>
                </div>
                <!-- /Title -->
                                                            ...
                                                            <div class="btn-group">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div role="menu" class="dropdown-menu">
                                                                        ...
                                                                        <a class="dropdown-item visitModal" data-id="{{ base64_encode($data->id) }}" href="javascript:void(0)"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Visit Date</a>
