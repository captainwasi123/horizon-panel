...
@php $date_remind = date('Y-m-d', strtotime("-7 days")); @endphp
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="icon-people"></i></span>Queries | HBM</h4>
                </div>
                <!-- /Title -->
                                                            ...
                                                            <div class="btn-group">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div role="menu" class="dropdown-menu">
                                                                        <a class="dropdown-item sale" data-id="{{ base64_encode($data->id) }}" href="javascript:void(0)"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Sales</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.sale', function() {
                ...
                $("body").removeAttr('class');
                $.toast({
                    heading: 'Are you sure you want to move this to Sales?',
                    text: '<i class="jq-toast-icon ti-alert"></i><a href="{{ URL::to("/")}}/hbm/query/sale/'+del_data+'" class="btn btn-primary btn-sm">&nbsp;&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;</a>',
                    position: 'top-center',
                    loaderBg:'#7a5449',
                    class: 'jq-has-icon jq-toast-warning',
                    hideAfter: 3500, 
