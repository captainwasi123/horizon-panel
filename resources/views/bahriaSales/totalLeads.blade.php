...
@section('title', 'Total Leads - Bahria')
@section('content')
...
@php $date_remind = date('Y-m-d', strtotime("-7 days")); @endphp
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="icon-people"></i></span>Total Leads - Bahria</h4>
                </div>
                <!-- /Title -->
                                                            ...
                                                            <div class="btn-group">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div role="menu" class="dropdown-menu">
                                                                        <a class="dropdown-item targetModal" data-id="{{ base64_encode($data->id) }}" href="JavaScript:void(0)"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Potential</a>
                                                                        ...
                                                                        <a class="dropdown-item" href="{{URL::to('/')}}/bahria/sales/quotation/{{ base64_encode($data->id) }}"><i class="fa fa-dollar"></i>&nbsp;&nbsp;&nbsp;Quotation</a>
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{URL::to('/bahria/sales/leads/potential/target')}}">
                                        {{csrf_field()}}
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.pendingLead', function() {
                ...
                $.toast({
                    ...
                    text: '<i class="jq-toast-icon ti-alert"></i><a href="{{ URL::to("/")}}/bahria/query/status/6/'+del_data+'" class="btn btn-primary btn-sm">&nbsp;&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;</a>',
                    position: 'top-center',
                    loaderBg:'#7a5449',
            ...
            $(document).on('click', '.convert', function() {
                ...
                $.toast({
                    ...
                    text: '<i class="jq-toast-icon ti-alert"></i><a href="{{ URL::to("/")}}/bahria/query/convert/'+del_data+'" class="btn btn-primary btn-sm">&nbsp;&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;</a>',
                    position: 'top-center',
                    loaderBg:'#7a5449',
                    class: 'jq-has-icon jq-toast-warning',
                    hideAfter: 3500, 
