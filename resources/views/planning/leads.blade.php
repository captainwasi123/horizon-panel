...
@section('content')
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="fa fa-tasks"></i></span>Leads</h4>
                </div>
                <!-- /Title -->
                                                            ...
                                                            <div class="btn-group">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div role="menu" class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{URL::to('/sales/quotation/'.base64_encode($data->id))}}"><i class="fa fa-tasks"></i>&nbsp;&nbsp;Plan</a>
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{URL::to('/sales/assign/person')}}">
                                        {{csrf_field()}}
