           ...
           <!-- Container -->
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="fa fa-plus"></i></span>Add Requisition</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="row">
	                                        ...
	                                        <div class="col-md-8">
		                                    	<form method="post" action="{{ URL::to('/construction/requisition/insert')}}">
		                                    		{{ csrf_field() }}
		                                        	<div class="row">
			                                        	<div class="col-md-12">
				                                        	...
				                                        	<select class="form-control form-control-lg select2" name="client_id" required>
				                                        		...
				                                        		@foreach($leads as $key => $val)
				                                        			<option value="{{$val->id}}">{{$s.' - '.$val->name}} | Plot#: {{empty($val->plot_no) ? '---' : $val->plot_no}} | Precent: {{empty($val->precent) ? '---' : $val->precent}}</option>
				                                        			@php $s++; @endphp
				                                        		@endforeach
				                                        	</select>
			                                        	</div>
		                                        	...
		                                        	<div class="row">
			                                        	...
			                                        	<div class="col-md-3">
			                                        		...
			                                        		<input type="number" name="qty" class="form-control form-control-sm" value="1" required>
			                                        	</div>
			                                        	<div class="col-md-3">
		                                        	...
		                                        	<div class="row">
			                                        	<div class="col-md-4">
			                                        		...
			                                        		<input type="date" name="needDate" class="form-control form-control-sm">
				                                        	<br>
			                                        	...
			                                        	<div class="col-md-8">
				                                            ...
				                                            <textarea placeholder="" name="remarks" autocomplete="false"  class="form-control form-control-sm" rows="5"></textarea>
			                                        	</div>
			                                        </div>
			                                        <br>
			                                        <div class="row">
