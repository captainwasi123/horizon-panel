...
@section('content')
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="fa fa-list"></i></span>Requisitions</h4>
                    <div class="right_side">
                    	<a href="{{ URL::to('/construction/requisition/add') }}" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Add Request</a>
                    </div>
                </div>
                <!-- /Title -->
                                            ...
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><p class="date-label"><strong>{{$data->client->name}}</strong><br>Precent: {{$data->client->precent}} | Plot#: {{$data->client->plot_no}}</p></td>
                                                        <td>
                                                            @if($data->status == 1)
                                                        ...
                                                        <td>
                                                            @if($data->status == '1' || $data->status == '2')
                                                                <a class="btn btn-primary btn-sm" href="{{URL::to('/')}}/construction/requisition/edit/{{ base64_encode($data->id) }}"><i class="fa fa-edit"></i>&nbsp;Edit</a>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    @php
